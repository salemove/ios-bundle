...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaCoreSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/2.6.7/GliaCoreSDK.xcframework.zip",
            checksum: "0291da8386750c6853b5a3c6447b77c4b56bbea47becc1471111f99ef877ec0d"
        ),
        .binaryTarget(
