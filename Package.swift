...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaCoreSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/1.1.0/GliaCoreSDK.xcframework.zip",
            checksum: "d481034ae0c87ab9be61d0f2d7aa00e1fce35055e20bf03f1f3494a4a70a884d"
        ),
        .target(
            name: "GliaSDK",
            dependencies: [
