...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SalemoveSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/0.35.8/SalemoveSDK.xcframework.zip",
            checksum: "3452a8a9d89f62dbe20b51d978d155343a5a7cb81e45444e54b70b77ccf40685"
        ),
        .target(
            name: "GliaSDK",
            dependencies: [
