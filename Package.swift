...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SalemoveSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/0.35.7/SalemoveSDK.xcframework.zip",
            checksum: "d0c8274e602fb1128c9ccc211b77710e6cc5933012600084ea125963262cddd4"
        ),
        .target(
            name: "GliaSDK",
            dependencies: [
