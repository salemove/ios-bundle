...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SalemoveSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/1.0.0/SalemoveSDK.xcframework.zip",
            checksum: "0c5d4e948d8d6063bd6a94207d14d3e99f49f572d0d09164e706dbb970b28ec1"
        ),
        .target(
            name: "GliaSDK",
            dependencies: [
