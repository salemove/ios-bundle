...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SalemoveSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/0.34.1/SalemoveSDK.xcframework.zip",
            checksum: "ddef05b1dab067d815744d45e2ee30a64fb3234943acae669c7becfd6444bee6"
        ),
        .target(
            name: "GliaSDK",
            dependencies: [
