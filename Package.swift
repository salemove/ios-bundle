...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaCoreSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/2.0.3/GliaCoreSDK.xcframework.zip",
            checksum: "a9875afc229c106cd91c585809f3dc38e9d8a674d207e708d55c5377555a7093"
        ),
        .target(
            name: "GliaSDK",
            dependencies: [
