...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SalemoveSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/0.35.10/SalemoveSDK.xcframework.zip",
            checksum: "1106cbd51c7e907b10ebcc2396862542adc32e458c588a5d778c569b475f07db"
        ),
        .target(
            name: "GliaSDK",
            dependencies: [
