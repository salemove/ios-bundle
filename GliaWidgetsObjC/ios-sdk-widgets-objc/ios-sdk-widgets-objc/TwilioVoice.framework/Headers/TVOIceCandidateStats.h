 ...
 *
 * @discussion For local candidates, `YES` indicates that the candidate has been deleted/freed as described by
...
/**
 * @brief The IP address of the candidate, allowing for IPv4 addresses and IPv6 addresses, but fully qualified domain
 * names (FQDNs) are not allowed. See [RFC5245] section 15.1 for details.
 */
...
/**
 * @brief The protocol used by the candidate. The valid values for transport is one of udp and tcp. Based on the
...
/**
 * @brief The URL of the TURN or STUN server indicated in the that translated this IP address. It is the URL address
 * surfaced in an peer connection ice event.
 */
 ...
 */
- (null_unspecified instancetype)init __attribute__((unavailable("TVOIceCandidateStats cannot be created explicitly.")));
